  ...
  const projects = [
    {
      ...
      client: "TechFlow Inc.",
      description: "Developed a comprehensive AI-powered CRM system that uses machine learning to predict customer behavior, automate follow-ups, and optimize sales processes.",
      challenge: "The client needed a solution to manage 10,000+ customers while providing personalized experiences and predictive analytics.",
      solution: "Built a scalable SaaS platform with ML-powered lead scoring, automated workflow engine, and real-time analytics dashboard.",
      results: [
      ...
      timeline: "6 months",
      testimonial: {
        quote: "IntelixTech transformed our sales process completely. The AI recommendations are incredibly accurate.",
    ...
    },
    {
      ...
      description: "Created a HIPAA-compliant mobile application for patient management, appointment scheduling, and secure communication between healthcare providers.",
      challenge: "Building a mobile solution that meets strict healthcare compliance requirements while maintaining excellent user experience.",
      solution: "Developed native iOS and Android apps with end-to-end encryption, biometric authentication, and comprehensive audit trails.",
      results: [
      ...
      timeline: "8 months",
      testimonial: {
        quote: "The app exceeded our expectations. Security and usability perfectly balanced.",
    ...
    },
    {
      ...
      description: "Built a real-time financial analytics platform with advanced security features for processing sensitive trading data and generating investment insights.",
      challenge: "Processing massive volumes of financial data in real-time while maintaining bank-level security and regulatory compliance.",
      solution: "Implemented a microservices architecture with advanced encryption, real-time data processing, and comprehensive compliance reporting.",
      results: [
      ...
      timeline: "10 months",
      testimonial: {
        quote: "Their expertise in secure financial systems is unmatched. Outstanding results.",
    ...
    },
    {
      ...
      description: "Developed an AI-powered recommendation system that personalizes product suggestions and optimizes pricing strategies for e-commerce platforms.",
      challenge: "Creating personalized shopping experiences for millions of users with diverse preferences and behaviors.",
      solution: "Built a machine learning system using collaborative filtering, deep learning, and real-time personalization algorithms.",
      results: [
      ...
      timeline: "5 months",
      testimonial: {
        quote: "The AI recommendations have revolutionized our customer experience and sales.",
    ...
    },
    {
      ...
      description: "Implemented a comprehensive security management system with threat detection, incident response, and compliance monitoring for large enterprises.",
      challenge: "Managing security across multiple locations and systems while providing real-time threat detection and response capabilities.",
      solution: "Created an integrated security platform with AI-powered threat detection, automated response systems, and comprehensive reporting.",
      results: [
      ...
      timeline: "12 months",
      testimonial: {
        quote: "This system has transformed our security posture. Highly recommended.",
                ...
                <div className={index % 2 === 1 ? 'lg:col-start-1' : ''}>
                  <Card className="card-tech hover-lift overflow-hidden">
                    <CardContent className="p-0">
                      <div className={`h-64 ${project.image} flex items-center justify-center relative`}>
                      ...
                      <div className="p-6">
                        <blockquote className="border-l-4 border-secondary pl-4 italic">
                          <p className="text-muted-foreground mb-2">"{project.testimonial.quote}"</p>
                          <footer className="text-sm font-medium">— {project.testimonial.author}</footer>
                        </blockquote>
                      </div>
                    </CardContent>
                  </Card>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary-light">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Join our roster of satisfied clients and transform your business with 
